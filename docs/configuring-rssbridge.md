...
Refer to [`config.default.ini.php`](https://raw.githubusercontent.com/RSS-Bridge/rss-bridge/refs/heads/master/config.default.ini.php) for a complete list of RSS-Bridge's config options that you can put in `rssbridge_config_additional_configurations`.
